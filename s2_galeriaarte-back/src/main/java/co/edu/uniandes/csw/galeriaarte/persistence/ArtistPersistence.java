...
public class ArtistPersistence {
    ...
    /**
     * Devuelve todas las artistes de la base de datos.
     *
     * @return una lista con todas las artistes que encuentre en la base de
    ...
    public List<ArtistEntity> findAll() {
        ...
        // Se crea un query para buscar todas las artistes en la base de datos.
        TypedQuery query = em.createQuery("select u from ArtistEntity u", ArtistEntity.class);
        // Note que en el query se hace uso del método getResultList() que obtiene una lista de artistes.
