...
public class CVLogic
{
 ...
 /**
    ...
    {
        LOGGER.log(Level.INFO, "Inicia proceso de borrar la hoja de vida del artista con id ={0}" ,artistId);
        ...
        LOGGER.log(Level.INFO, "Termina proceso de borrar la hoja de vida para el artista del artista id ={0}" ,artistId);
    }
}
