...
public class MedioPagoResource
{
    ...
    {
        LOGGER.log(Level.INFO, "EditorialResource createEditorial: input: {0}", medioPago.toString());
        return medioPago;
    }
    ...
    @DELETE
    @Path("{medioPagoId: \\d+}")
    public void deleteMedioPago(@PathParam("editorialsId") Long medioPagoId) {
        LOGGER.log(Level.INFO, "EditorialResource deleteEditorial: input: {0}", medioPagoId);
